...
@section('content-header', 'Mijozni Tahrirlash: ' . $customer->full_name)
            ...
            <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST">
                ...
                @method('PUT') <div class="form-group">
                    ...
                    <input type="text" name="full_name" class="form-control @error('full_name') is-invalid @enderror" id="full_name"
                           placeholder="Mijozning to'liq ismini kiriting" value="{{ old('full_name', $customer->full_name) }}">
                    @error('full_name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="passport_number" class="form-control @error('passport_number') is-invalid @enderror" id="passport_number"
                           placeholder="AA1234567" value="{{ old('passport_number', $customer->passport_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number"
                           placeholder="+998901234567" value="{{ old('phone_number', $customer->phone_number) }}">
                    @error('phone_number')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email"
                           placeholder="Mijoz emailini kiriting" value="{{ old('email', $customer->email) }}">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                ...
                <hr>
                <p class="text-muted">Parolni o'zgartirishni xohlasangizgina yangi parol kiriting.</p>
